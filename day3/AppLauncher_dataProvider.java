...
public class AppLauncher_dataProvider extends ProjectSpecificMethod {
	@DataProvider
	public Object[][] sendData()
	{
		String[][] s=
		 {
	            {"Testleaf", "Description1", "vinitha"},
	            {"Salesforce", "Description2", "xxxxx"}
	        };
		return s;
	...
	public void appLauncher(String c_name,String Desc,String s) throws InterruptedException
	{
